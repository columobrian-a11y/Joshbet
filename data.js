...
const diaryData = {
  entries: [
    ...
    },
    {
      ...
      mood: 3,
      exercise: "Rest day",
      habits: { water: true, movement: false, reading: true, meditation: false },
      activities: ["Long work day", "Read before bed"],
      notes:
        "Average day. Slept badly the night before so was running on low energy. Reading before bed helped me wind down though.",
      photos: [],
    },
    {
      date: "2026-07-09",
